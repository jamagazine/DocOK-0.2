Ты — эксперт-корректор спецификаций. Markdown-таблица.
...
5. Если в колонке pos (позиция) указан символ § — это локация (LOCATION). Обязательно верни для такой строки row_type: LOCATION.
